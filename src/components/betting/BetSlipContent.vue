          ...
          <div class="w-full space-y-3">
            <div class="flex gap-2">
              <input 
                ...
                maxlength="10"
                class="flex-1 bg-cyan-900/50 border border-cyan-700 rounded-lg px-3 py-2 text-cyan-100 text-xs font-mono tracking-wider uppercase outline-none focus:border-yellow-400 placeholder:text-cyan-600 placeholder:tracking-normal"
                @keyup.enter="submitLoadBookingCode"
              />
              <button 
                @click="submitLoadBookingCode"
                :disabled="isLoadingBookingCode || !loadCodeInput.trim()"
                class="px-6 py-2 rounded-lg text-xs font-bold bg-gradient-to-r from-yellow-500 to-yellow-400 text-cyan-950 disabled:opacity-50 whitespace-nowrap"
              >
