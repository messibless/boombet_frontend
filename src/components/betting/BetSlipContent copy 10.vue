    ...
    <Transition name="fade">
      <div v-if="showSuccessModal"
        ...
        <div class="bg-cyan-950 border border-cyan-700 rounded-2xl p-5 mx-4 text-center w-full max-w-sm">
          ...
          <!-- <p class="text-xs text-cyan-400 mb-3">Ticket Code</p> -->
          <!-- <p class="text-2xl font-black font-mono text-yellow-400 tracking-widest mb-4">{{ placedBetData?.ticket_code }}</p> -->
...
const taxAmount = computed(() => {
  return potentialWin.value * 0.12 // 12% Excise Duty
})
