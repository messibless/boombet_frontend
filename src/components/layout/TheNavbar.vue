<template>
  ...
  <div class="w-[34px] h-[34px] rounded-lg bg-[var(--grad-gold)] text-yellow-400 font-display font-black text-base flex items-center justify-center">BM</div>
  <span class="font-display text-[17px] font-bold tracking-[2px] bg-[var(--grad-gold)] bg-[length:200%_auto] text-transparent bg-clip-text animate-[shimmer_3s_linear_infinite] hidden sm:inline-block">BOOMBET</span>
</RouterLink>
        </div>
